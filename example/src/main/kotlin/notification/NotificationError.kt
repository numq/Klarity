    ...
    Notification(notificationQueue = notificationQueue) { item ->
        Box(
            ...
            Row(
                ...
                Text(text = item.message, textAlign = TextAlign.Center, color = MaterialTheme.colors.onSurface)
                Icon(Icons.Default.ErrorOutline, null, tint = MaterialTheme.colors.onSurface)
            }
        }
    }
}