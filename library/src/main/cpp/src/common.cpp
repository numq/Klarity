...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    decoderExceptionClass = reinterpret_cast<jclass>(
            env->NewGlobalRef(env->FindClass("io/github/numq/klarity/decoder/DecoderException"))
    );
    ...
    hardwareAccelerationExceptionClass = reinterpret_cast<jclass>(
            env->NewGlobalRef(env->FindClass("io/github/numq/klarity/hwaccel/HardwareAccelerationException"))
    );
    ...
    poolExceptionClass = reinterpret_cast<jclass>(
            env->NewGlobalRef(env->FindClass("io/github/numq/klarity/pool/PoolException"))
    );
    ...
    samplerExceptionClass = reinterpret_cast<jclass>(
            env->NewGlobalRef(env->FindClass("io/github/numq/klarity/sampler/SamplerException"))
    );
    ...
    formatClass = reinterpret_cast<jclass>(
            env->NewGlobalRef(env->FindClass("io/github/numq/klarity/format/NativeFormat"))
    );
    ...
    audioFrameClass = reinterpret_cast<jclass>(
            env->NewGlobalRef(env->FindClass("io/github/numq/klarity/frame/NativeAudioFrame"))
    );
    ...
    videoFrameClass = reinterpret_cast<jclass>(
            env->NewGlobalRef(env->FindClass("io/github/numq/klarity/frame/NativeVideoFrame"))
    );
